public class BombaDeCombustivel{
	...
	public void puxarGancho(){
		...
		System.out.println("Bomba pronta para abastecer. Combustivel escolhido: "+this.combustivel);		
	}

	public void voltarGancho(){
		this.emAbastecimento = false;
		System.out.println("+----------------------------------+");
		System.out.println("| Posto do Daniel  - Recibo.       |");
		System.out.println("+----------------------------------+");
	...
	public void abastecerPorLitros(float litros){
		if (this.emAbastecimento){
			...
			System.out.println("Tire a bomba do gancho");
		}
	}
